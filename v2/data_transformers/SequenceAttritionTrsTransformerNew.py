...
class SequenceAttritionTrsTransformerNew(BaseTrsTransformer):
    ...
    def _use_related_project_status(self):
        self.data = self.data[(self.data['project status'] == 'In project') or (self.data['project status'] == 'IN_PROJECT')]
